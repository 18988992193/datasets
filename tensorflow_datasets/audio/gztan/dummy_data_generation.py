...
from tensorflow_datasets.audio.gztan import gztan
...
def _output_dir():
  return os.path.join(FLAGS.tfds_dir, "audio", "gztan", "dummy_data")


def _generate_data():
  """Generate data examples."""
  # pylint: disable=protected-access
  labels = tfds.features.ClassLabel(names=gztan._CLASS_LABELS).names  # pytype: disable=module-attr
